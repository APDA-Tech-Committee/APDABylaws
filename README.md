...
APDA shall maintain a “Best Practices” document in Appendix B. This document may be amended by a two-thirds vote of the members at a meeting that satisfies a quorum. Violation of best practices or any other bylaws may be considered when voting on future sanctioning.
...
If there is only one APDA-sanctioned tournament scheduled for a particular weekend, that tournament is considered “unopposed.” Each member institution which hosts an unopposed tournament (excluding the National and North American Championships) shall pay APDA a fee in the amount of $7 for each 2-person team that competes at its tournament, excluding the first sixty 2-person teams. The fee must be paid to APDA no later than 3 months after the conclusion of the tournament or before APDA’s next National Championship tournament, whichever comes first. Tournaments need to pay a size tax to the APDA Board. The tax is calculated  (N-3R-55)\*(X), where N is the number of teams at the tournament, R is complete reg breaks given, X is Reg - 115

D. Meals

Tournaments are required to provide meals during all times when the majority of competitors are scheduled to be present. This includes breakfast before 10 AM, lunch between 10 and 3, and dinner later than that. Tournaments shall ask that teams indicate the dietary restrictions of their competitors, observers, and judges at least 24 hours prior to the tournament start. If an option for a requested restriction is not provided, the host team must provide a monetary stipend to any affected individual whose indicated dietary needs are not accommodated. 
...
In the event that the sanctioned schedule has tournaments that are to be held solely online, they must not charge more than $30 in registration fees. 5.08\[D\] shall not apply to online tournaments.
...
Individual exceptions to any portion of these bylaws must be voted on by the body and approved by all or all but one of the members voting in order to be valid. The body reserves the right to levy fees against any schools that violate the bylaws with a majority vote at an APDA meeting filling quota.
