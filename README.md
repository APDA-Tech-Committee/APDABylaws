...
\*\***As a result of COVID-19, all members in good standing as of April 1st, 2020, shall be considered to have met the requirement of having had 2 debaters attend 3 tournaments in the 2020-2021 and the 2021-2022 season. In addition, any organization which becomes an APDA member in good standing subsequent to April 1st, 2020 but prior to September 1st, 2022 shall be considered to have met the requirement of having had 2 debaters attend 3 tournaments in the 2020-2021 and 2021-2022 seasons.** 
...
This section supercedes any other language as it pertains to the 2022 National Championship. An individual or individuals may be sponsored to compete at the 2022 National Championship if that individual is qualified by: (1) Earning a cumulative total of 10 points whereas winning a qualifying tournament earns 12.5 points, finaling earns 10 points, semifinaling earns 7.5 points, quarterfinaling earns 5 points, octofinaling earns 2.5 points, and double octofinaling earns 1.25 points; (2) Advancing to the quarterfinal round or being one of the two highest-ranking teams from the United States at the North American Debate Championships during the 2021-2022 season; (3) Advancing to elimination rounds, or to English as a Second or Foreign language finals, at the most recent World Universities Debating Championship; (4) Advancing to the final round or being one of the two highest-ranking teams from the United States at the North American Universities British Parliamentary Debating Championship; or (5) Advancing to the semifinal round at the Yale IV.
...
The following section is only applicable to the 2020-2021 season (with exception of F, which will only be applicable to the 2022-23 season) and takes priority over all other language contained in this document.
...
B. Preserving Voting Eligibility. As a result of COVID-19, all members in good standing as of April 1st, 2020, shall be considered to have met the requirement of having had 2 debaters attend 3 tournaments in the 2020-2021 season. In addition, any organization which becomes an APDA member in good standing subsequent to April 1st, 2020 but prior to September 1st, 2021 shall be considered to have met the requirement of having had 2 debaters attend 3 tournaments in the 2020-2021 season.

C. Competitive eligibility. A competitor is eligible to compete in the 2020-2021 season if they had eligibility in Spring 2020 and they were affiliated with a member institution in Spring 2020. 

D. Club of the Year. COTY shall not be determined for the 2020-2021 academic year. 

E. Novice of the year. NOTY shall not be determined for the 2020-2021 academic year. 

F. Nationals Qualification. An individual or individuals may be sponsored to compete at the 2023 National Championship if that individual is qualified by: (1) Earning a cumulative total of 10 individual TOTY points; (2) Advancing to the quarterfinal round or being one of the two highest-ranking teams from the United States at the North American Debate Championships during the 2022-2023 season; or (3) Advancing to the semifinal round at the Yale IV.

G. Scheduling. There shall only be one (1) sanctioned tournament per weekend, to be sanctioned a tournament must have at least eight (8) teams compete in more than half of the in-rounds, be held on either Discord or Zoom, and not charge more than $30 in registration fees. 5.08\[D\] shall not apply to online tournaments.
...
3\. Invoices required for team participation at APDA-sanctioned tournaments shall include the following information:

*   Host school name, followed by the words “Debate Tournament”
*   Dates of the tournament
*   The words “Official Team Invoice”
*   Number of teams invoiced school has officially sent
*   Cost per team, as calculated by the host school
*   Total cost of invoiced school’s teams
*   Host school’s federal tax ID number
*   “Mail To” Information
*   “Bill To” Information

4\. Non-title tournaments ought offer debaters the option of justifying tab scratches to the debater’s choice of either the tab observer, equity officers, or the tab director (or designee thereof) at some point prior to round one. The person approving the scratch ought not be the person on whom the tab scratch is being justified.

5\. During rounds at all sanctioned APDA tournaments, the tab director may choose to cap points of clarification and/or case construct at a total of at most 15 minutes in maximum length. Tournaments should inform judges and competitors that Points of Clarification may be cut off at any point conditional on both teams’ consent.

6\. All tournaments should specify the conditions, composition, and size of the break prior to the beginning of their tournament (e.g., prior to the start of round one).

7\. Sanctioned tournaments should provide certain tab data to the APDA Board by 11:59 PM Eastern Standard Time on the second Sunday after the tournament. Such data shall be submitted electronically and include: the full speaker tab (including novice status), the full team tab, the pairings for each round (including out-rounds and out-rounds judging), and the results of all outrounds (including the decisions and the sides of each team in each round). This is to be submitted in both a human-readable format (PDF or Google Docs) and a machine-readable format (JSON, CSV, or DebateXML in descending order of preference).

8\. Sanctioned tournaments should post on https://apda.online/forum/ the results of their tournament by 11:59 PM on the Monday after the tournament. As a reminder, these results may include no ties. These results should include:

*   A thank you to the dinos who attended the tournament, as well as a list of those who did so.
*   The number of teams which competed in more than half of the preliminary rounds. Ironman teams are considered half a team for the purposes of the count.
*   The number of novices who competed in more than half the preliminary rounds.
*   An ordered list of at least the top ten novice speakers, including the school, team, and speaker points of each, as well as the methods used to break any ties.
*   An ordered list of at least the top five novice teams, including the names of the debaters, their school(s), their preliminary round record, their total speaker points, and the methods used to break any ties. This list should incorporate the results of novice outrounds, including the decision (e.g. "3-2") and the team each team dropped to (excepting the winner of novice outrounds and any novice teams which are included in the varsity break).
*   An ordered list of at least the top ten varsity speakers, including novice status if it is relevant, as well as the school, team, and speaker points of each, and the method used to break any ties.
*   An ordered list of at least the teams which made the varsity break, including the names of the debaters, their school(s), their preliminary round record, their total speaker points, and the methods used to break any ties. This list should incorporate the results of varsity outrounds, including the decision and the team each team dropped to (excepting the champions).
*   The government team in the final round and the case statement of the case they ran. If the tournament does not involve cases, the motion and model used in the final round should be listed instead. If the case is opp-choice, the side chosen by the opposition should be listed. If the case was tight-called or spec-called, that should be listed. If the case was counter-cased, that should be listed in addition to the opposition's countercase. If a team in the final round requests that some of the information about the final round case not be posted, the tournament should comply with their request.

9\. Tournaments that allow discretionary scratches should allow only team scratches, as opposed to a combination of team and school scratches. A team scratch shall be a scratch chosen and applied to a team of debaters. A school scratch shall be a scratch chosen by and applied to an entire school. This shall not be interpreted to apply to tab scratches.

10\. All regular season tournaments should instruct judges to deliver adjudication and feedback in non-elimination rounds after the round and after they have signed their ballots. Judges should provide at least the decision, a discussion of the reason for the decision, and constructive criticism for the debaters in the round. Tournaments should instruct that all judges disclose the same amount of information for all non-elimination rounds.

11\. All tournaments, in their invitations, should disclose which meals they will be providing at no cost, what will be served for each meal, and any dietary restrictions that will not be satisfied by each provided meal. Additionally, no later than the date when a tournament is closing preliminary registration, the tournament must disclose what measures will be taken to provide food for those with dietary restrictions, religious considerations, and allergies; it is recommended that tournaments designate a point person for special dietary needs. Labels on food should be an expected part of this process. If a cash stipend is to be offered to individuals whose dietary needs are not met by the tournament menu, the tournament must disclose the amount of the stipend and a nearby restaurant or store that provides a meal for the noted amount that will satisfy the debaters’ needs. This stipend should be rendered to tournament attendees at the time of tournament check-in. If a tournament is online, this Best Practice does not apply.

12\. Tournaments ought to have policies that discourage judges from communicating, verbally or non-verbally, with other judges while a debate is occurring.

13\. Tournaments should have tab observers approved by the APDA Board. Tournaments should submit a tab observer for approval no later than two weeks prior to the tournament date.

14\. APDA Schools should give substantial registration breaks, or free registration if financially feasible, to schools that are hosting the APDA National Championship that year, noting that the financial need of the host school should be considered.

15\. Tournaments should aim to announce all speaker awards, novice and varsity, as well as the novice break at the same time that the varsity break is announced. In the case that all tiebreaks in tab policy have been exhausted and a speaker award(s) would be decided by coin flip, tabrooms should announce all tied speakers as having tied for the higher speaker placement.

16\. Tournaments should include the following document in their tab packets: [Speaker Scale](https://docs.google.com/document/d/1yptW79G1oL9mNDhCPcuZf0zwibPtz05-Xg6qjGjC9FU/edit#heading=h.yol2z5jxosjn)

17\. Tournaments should attempt to utilize the judges that are available for any given round, including paneling rounds and assigning judges as non-voting wings on a panel.

18\. Tournaments should offer debaters the opportunity to justify a clash against another debater to the tab staff, the tournament observer, or the tournament equity officers. The justification bar for a debater clash ought to be higher than a judge tab scratch. Additionally, the tournament should make an effort to anonymize the clash or, at the very least, limit the number of people that have access to the clash justification. Debater clashes only apply to in-rounds. If scratched teams hit during out rounds, tab staff must notify equity officers, who shall make a recommendation (after talking with the individual who submitted the scratch) as to how to hold the round in the most equitable manner possible.

19\. If competitors have technical issues, each team has a total of ten minutes of “tech-time” for the duration of the round to fix problems. Competitors who cannot fix technical issues within the allotted time will forfeit the round. Judges should alert tab if a team uses all of their tech time. (1) Judges should keep track of tech time.  (2) Round participants may not use tech time to prepare speeches or any other purpose that is not outlined in (20).

20\. If a judge has technical difficulties, competitors should notify tab immediately. If the judge cannot resolve the difficulties after 10 minutes, depending on how far into the round it is, the tabroom should make a decision to either award a bye to both teams or to send a new judge and restart the round. If there is a panel, a qualified panelist may be promoted to chair and continue the round.

21\. Tournaments should not allow rounds in which some debaters are present in the same room as the judge while others are participating virtually. If such a round arises, tournaments should instruct judges to judge the round from a room separate from all debaters in the round.

21\. Tournaments should ensure that their tournament is accessible to disabled participants. Tournaments should follow EOF recommendations about disability accommodations for participants in and out of round.

23\. Ahead of a motions tournament, the EOF liaison and EOF chair(s) should approve individuals, ideally but not necessarily current or former Equity Officers, who are not competing at the tournament to review the motions. All potential motions should be reviewed by these selected individuals prior to 48 hours before the start of the tournament and the tournament should consider any content warnings. If there is complete disagreement about the content warnings, the tournament should err on the side of including additional content warnings. The bar for a motion content warning is any sensitive topic that could realistically come up in round. If a motion has a content warning and is opted out of, then a new motion should be provided to the judge, who will then provide it to the teams at the same time in the competition room.

24\. Tournaments ought, barring motions redacted due to sensitive topic area, post all debated motions, and their gov/opp win rates. If there is an opt-out, tournaments should post the backup motion that is debated. These should be posted alongside the tournament results post (see BP 8).

25\. Tournaments ought prohibit the use of generative AI at tournaments, and include in their tab policies that the use of such technology constitutes an auto-drop.

26\. Schools that intend to host the APDA National Championship should publicize a budget to the body during the scheduling process. Once a host for the APDA National Championship is selected, the hosting schools should publicize a budget including, but not limited to: expected reg, reg breaks, banquet venue, food costs, room renting costs, and alumni subsidies.

27\. Assuming debater consent, tournaments should designate a random room within the top 2 brackets as a ‘recording room’ that records all rounds that occur within the room (with debater consent). Assuming debater consent, tournaments should record at least one outround from every set of outrounds that occur (one quarterfinal, one semifinal, etc.).

28\. Tournaments ought not accept tab scratches from third-parties not named in the tab scratch, unless that scratch has been approved by two members of the equity and/or tab staff. This best practice shall not be construed to preclude schools from notifying tournaments of debaters with additional affiliations.

29\. Motions tournaments should include [this motion wording guide](https://docs.google.com/document/d/1NDDpfFhQ90fU0hde_u3CmwyVTz8okVcLM9fJMU75hgQ/edit?usp=sharing) in their tab policies and advertise it in any relevant spaces (eg, Facebook pages, GroupMe chats, Discord channels, etc.). Similarly, chief adjudicators' motion briefings should mirror the rules outlined in this document. If chief adjudicators wish to introduce another motion type, they should make the rules for that new motion type clear to debaters in advance of round 1.

30\. Tournaments should aim to nominate in-person tab observers whenever possible. This best practice shall not be construed to prohibit the nomination of virtual tab observers when an in-person tab observer cannot be found.
